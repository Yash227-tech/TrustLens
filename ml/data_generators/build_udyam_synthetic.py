"""Append synthetic Udyam (MSME) certificates to the LayoutLMv3 training manifest.
...
classifier), this generates ONLY udyam_certificate PDFs into
/data/synthetic/udyam_certificate/ and rewrites /data/synthetic/labels.jsonl =
...
train_layoutlmv3 run becomes a 25-class model with udyam_certificate included.
...
from data_generators.templates import udyam_certificate  # noqa: E402
...
def main() -> None:
    ...
    for i in range(args.count):
        try:
            pdf_bytes, fields = udyam_certificate()
